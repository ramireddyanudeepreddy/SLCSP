# SLCSP
---------------------------------------------------------------------------------------------------------------------------------------
By default the code takes the path of projectfolder/src/data/*
You can pass the path through run time in order [plans.csv , zips.csv, slcsp.csv]

Filenames should exactly match : plans.csv, slcsp.csv and zips.csv
...
the input. Write your code in Java (preferred) or Python.
